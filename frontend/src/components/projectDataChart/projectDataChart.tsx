...
export const ProjectDataChart: React.FC<ProjectDataChartProps> = ({
  ...
  return (
    <Box width="1440px" display="flex" flexDirection="column" gap={2}>
      <Card
        sx={{
          width: "100%",
          display: "flex",
        ...
        <Box width="100%" position="relative" mb={8}>
          ...
          >
            ...
            >
              ...
              <Box width="24px" height="24px" sx={{ background: colors[0] }} />
            </Box>
            <Box
              display="flex"
              gap={1}
            ...
            >
              ...
              <Box width="24px" height="24px" sx={{ background: colors[1] }} />
            </Box>
          </Box>
        </Box>
        <Box
