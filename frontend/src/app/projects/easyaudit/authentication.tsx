...
import { EA_ACCESS_COOKIE, getCookie, setCookie } from "@/hooks";
...
export const Authentication = () => {
  ...
  React.useEffect(() => {
    const accessKey = getCookie(EA_ACCESS_COOKIE);
    if (accessKey != "true") {
        ...
        <DialogContent>
          ...
          >
            ...
            <Box
              ...
              onSubmit={(e) => {
                e.preventDefault();
                if (password === "EASYAUDIT_ProACCESS!") {
                  setIsAuthenticated(true);
                  setAuthError(false);
                  setCookie(EA_ACCESS_COOKIE, "true");
                } else {
                  setAuthError(true);
                }
              }}
